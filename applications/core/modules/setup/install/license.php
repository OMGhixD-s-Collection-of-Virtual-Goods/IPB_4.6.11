...
class _license extends \IPS\Dispatcher\Controller
{
	...
	public function manage()
	{
		...
		$form->add( new \IPS\Helpers\Form\Text( 'lkey', 'a6f37dc05b427d82aa5a2e5b6e6229ed', TRUE, array( 'size' => 50 ), function( $val )
		{
		...
		if ( $values = $form->values() )
		{
			...
			$toWrite = "<?php\n\n" . '$INFO = ' . var_export( array( 'lkey' => 'a6f37dc05b427d82aa5a2e5b6e6229ed' ), TRUE ) . ';';
